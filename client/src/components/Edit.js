...
class Edit extends Component {
    ...
    render() {
      let isbn, title, author, description, published_year,qty, publisher;
      return (
                              ...
                              <div className="container">
                                  <div className="panel panel-default">
                                      ...
                                      <div className="panel-body">
                                          ...
                                          <form onSubmit={e => {
                                              e.preventDefault();
                                              updateBook({ variables: { id: data.book._id, isbn: isbn.value, title: title.value, author: author.value, description: description.value, publisher: publisher.value, qty:parseInt(qty.value),published_year: parseInt(published_year.value) } });
                                              isbn.value = "";
                                              title.value = "";
                                              author.value = "";
                                              description.value = "";
                                    ...
                                    <input type="number" className="form-control" name="qty" ref={node => {
                                        qty = node;
                                    }} placeholder="Quantity" defaultValue={data.book.qty}/>
                                </div>
                                              <div className="form-group">
